...
public class CreateAccFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        final EditText editPassword = rootView.findViewById(R.id.loginPassword_edit);
        final EditText editpassword2= rootView.findViewById(R.id.loginPassword_edit2);
            ...
            public void onClick(View view) {
                ...
                if(!editPassword.getText().toString().equals(editpassword2.getText().toString())){
                    ...
                    if(!db.getAccountNames().contains(nameEdit.getText().toString())){
                        ...
                        Log.d(LOG, "DB returns:" + db.getAccount().getUserName() + db.getAccount().getStringHash());
